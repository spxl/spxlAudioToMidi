...
public class MeterMonitor
{
  ...
  Point pointRel; // Mouse coordinates relative to monitor position
  ...
  public void mouseEvent(MouseEvent event)
  {
    ...
    boolean leftButton = (modifiersEx & MouseEvent.BUTTON1_DOWN_MASK) != 0;
    boolean rightButton = (modifiersEx & MouseEvent.BUTTON3_DOWN_MASK) != 0;
    ...
    else if (state == STATE_SET_LINK && eventID == MouseEvent.MOUSE_RELEASED)
    {
